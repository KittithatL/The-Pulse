...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // ✅ schema ใหม่: backend รับแค่ username/email/password
      const payload = {
        ...
        <div className="flex items-center justify-center px-6 py-6 sm:px-10 sm:py-8 lg:px-14 lg:py-10">
          <div className="w-full max-w-md">
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div className="pt-1">
                <div className="text-3xl font-extrabold italic tracking-tight text-black sm:text-4xl">
                  The Pulse
                </div>
                <div className="mt-1 text-[11px] font-extrabold tracking-[0.22em] text-slate-400">
                  SMARTER PROJECT DNA
                </div>
              </div>
            </div>
            ...
            <p className="mt-1 text-sm font-semibold text-slate-400 sm:text-base">
              Create your Pulse identity to enter the environment.
            </p>
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className="mt-5 space-y-4 2xl:space-y-3">
              {/* Username */}
              <div>
                <label className="text-xs font-extrabold tracking-[0.18em] text-slate-400">
                  USERNAME
                </label>
                <div className="mt-1 flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm 2xl:py-2.5">
                  <div className="grid h-9 w-9 place-items-center rounded-lg bg-slate-100 2xl:h-8 2xl:w-8">
                    <svg
                      viewBox="0 0 24 24"
              ...
              <div>
                ...
                <div
                  className={`mt-1 flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow-sm 2xl:py-2.5 ${
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 flex w-full items-center justify-center gap-3 rounded-full bg-red-600 py-4 text-lg font-extrabold text-white shadow-[0_18px_40px_rgba(255,0,0,0.35)] hover:brightness-110 active:scale-[0.99] disabled:opacity-60 2xl:py-3"
              >
